...
#     ])
#     def test_name(self, name, game_type, cut_off_characters, proportion, data_location):
...
#         getRawDataId = response_data[1]['PageData'][0]['RawDataId']  # 預設 第一筆資料
#         getRawDataType = response_data[1]['PageData'][0]['RawDataType']  # 預設第一筆資料
#         data = {"rawDataType":getRawDataType, "rawDataId": getRawDataId }
#         response_data = self.betRecord.getRawData(data)
#         name = response_data[1]['List'][data_location]['Name']
#         print(name)
#
#
#     # 呼叫方法
