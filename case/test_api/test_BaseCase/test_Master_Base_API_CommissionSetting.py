...
class CommissionSettingBaseTest(unittest.TestCase):
    ...
    def getId(self):
        ...
        length = len(response_data[1]['CommissionSettings']) - 1
        getId = response_data[1]['CommissionSettings'][length]['Id']
        return getId
    ...
    def test_CommissionSetting_relatedApi_status_04(self):
        """驗證 佣金設定 - 新增傭金等級"""
        data = {"commissionSetting": {"Name": "QA_automation", "MinWager": 1, "DepositPercent": 1, "DepositMax": 1,
    ...
    def test_CommissionSetting_relatedApi_status_09(self):
        ...
        # Step 1 取得ID
        getId = self.getId()
        data = {"commissionSetting": {"Id": getId, "Name": 'QA_automation' + common_config.now, "IsDisabled": 'false',
                                      "MinWager": 1,
